...
Mostly from https://github.com/bramp/Connected-component-labelling
...
function BlobExtraction(data, w, h) {
  ...
  var extr =  extract();
  console.log("blob extraction took", new Date().getTime() - start, 'ms')
  return extr
}
...
//        blob[l] = b;
  ...
  for (var i = 0; i < blob.length; i++) {
    ...
    b.cx = (b.x2 - b.x1)/2 + b.x1
    b.cy = (b.y2 - b.y1)/2 + b.y1
  }
...
function BlobColouring(dest, width, height, labels) {
  ...
  for (var i = 0; i <= maxcolors; i++) {
    ...
    colors[i] = [r * 255, g * 255, b * 255, 255];
  }
